...
namespace PetShop {
    ...
    public partial class dbPetShopDataSet : global::System.Data.DataSet {
        ...
        public partial class tblUserDataTable : global::System.Data.TypedTableBase<tblUserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tblUserRow AddtblUserRow(string name, string email, string phone, string role, System.DateTime dateBirth, string password) {
        ...
        public partial class tblUserRow : global::System.Data.DataRow {
            ...
            public System.DateTime dateBirth {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tabletblUser.dateBirthColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'dateBirth\' in table \'tblUser\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletblUser.dateBirthColumn] = value;
                }
            }
            ...
            public bool IsdateBirthNull() {
                return this.IsNull(this.tabletblUser.dateBirthColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetdateBirthNull() {
                this[this.tabletblUser.dateBirthColumn] = global::System.Convert.DBNull;
            }
...
namespace PetShop.dbPetShopDataSetTableAdapters {
    ...
    public partial class tblUserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tblUser] WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)) AND ((@IsNull_dateBirth = 1 AND [dateBirth] IS NULL) OR ([dateBirth] = @Original_dateBirth)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblUser] ([name], [email], [phone], [role], [dateBirth], [pass" +
                "word]) VALUES (@name, @email, @phone, @role, @dateBirth, @password);\r\nSELECT id," +
                " name, email, phone, role, dateBirth, password FROM tblUser WHERE (id = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblUser] SET [name] = @name, [email] = @email, [phone] = @phone, [role] = @role, [dateBirth] = @dateBirth, [password] = @password WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)) AND ((@IsNull_dateBirth = 1 AND [dateBirth] IS NULL) OR ([dateBirth] = @Original_dateBirth)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT id, name, email, phone, role, dateBirth, password FROM tblUser WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PetShop.Properties.Settings.Default.dbPetShopConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, email, phone, role, dateBirth, password FROM dbo.tblUser";
        ...
        public virtual int Fill(dbPetShopDataSet.tblUserDataTable dataTable) {
        ...
        public virtual dbPetShopDataSet.tblUserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbPetShopDataSet.tblUserDataTable dataTable = new dbPetShopDataSet.tblUserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbPetShopDataSet.tblUserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_email, string Original_phone, string Original_role, global::System.Nullable<global::System.DateTime> Original_dateBirth, string Original_password) {
            ...
            if ((Original_dateBirth.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((System.DateTime)(Original_dateBirth.Value));
            }
            else {
        ...
        public virtual int Insert(string name, string email, string phone, string role, global::System.Nullable<global::System.DateTime> dateBirth, string password) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string email, string phone, string role, global::System.Nullable<global::System.DateTime> dateBirth, string password, int Original_id, string Original_name, string Original_email, string Original_phone, string Original_role, global::System.Nullable<global::System.DateTime> Original_dateBirth, string Original_password, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string email, string phone, string role, global::System.Nullable<global::System.DateTime> dateBirth, string password, int Original_id, string Original_name, string Original_email, string Original_phone, string Original_role, global::System.Nullable<global::System.DateTime> Original_dateBirth, string Original_password) {
            return this.Update(name, email, phone, role, dateBirth, password, Original_id, Original_name, Original_email, Original_phone, Original_role, Original_dateBirth, Original_password, Original_id);
        }
    }
